...
public class ErrorMessagesLocalizationTests
{
    ...
    [InlineData("SecurityRateLimitedDetail")]
    [InlineData("SecurityLimiterUnavailable")]
    [InlineData("SecurityLimiterUnavailableDetail")]
    [InlineData("SecurityClientAddressUntrusted")]
    [InlineData("SecurityClientAddressUntrustedDetail")]
    [InlineData("QuotaUnavailable")]
    [InlineData("QuotaUnavailableDetail")]
